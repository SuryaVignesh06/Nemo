...
export function plannerSystem(): string {
  return [
    ...
    'Prefer Mermaid capabilities for structure, relationships, flow, sequence, state, and architecture.',
    'Prefer animated canvas/Manim capabilities for mathematics, physics, algorithms, circuits, signals, and change over time.',
    'Use both in one lesson when a structural overview and a dynamic explanation are complementary.',
    '',
    'You must NOT:',
